...
REM Date: JAN 2017
REM 1_6_RunBusinessRule_PNLPlanAGGRule.bat 
REM ---------------------------------------------------------
...
SET message="%date% %time% - 1_6_RunBusinessRule_PNLPlanAGGRule"
ECHO %message:"=%
ECHO %message:"=% >> %log_file%
CALL %epmautomate_client% RunBusinessRule %Rulename% ScenarioPrompt=%ScenarioPrompt% VersionPrompt=%VersionPrompt% MultiYearPrompt=%MultiYearPrompt% >> %log_file%
IF %ERRORLEVEL% NEQ 0 ( 
CALL :ErrorPara %message% %log_file% 
)
ECHO.
