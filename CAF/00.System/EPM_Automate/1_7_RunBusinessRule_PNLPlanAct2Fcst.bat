...
REM Date: Feb 2017
REM 1_7_RunBusinessRule_PNLPlanAct2Fcst.bat 
REM ---------------------------------------------------------
...
SET message="%date% %time% - 1_7_RunBusinessRule_PNLPlanAct2Fcst"
ECHO %message:"=%
ECHO %message:"=% >> %log_file%
CALL %epmautomate_client% RunBusinessRule %Rulename% VersionPrompt=%VersionPrompt% EntityPrompt=%EntityPrompt% ProjectPrompt=%ProjectPrompt% >> %log_file%
IF %ERRORLEVEL% NEQ 0 ( 
CALL :ErrorPara %message% %log_file% 
)
ECHO.
